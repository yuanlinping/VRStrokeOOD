...
def get_params(alg,args,nettype=''):
    ...
    if nettype=='TDBADV':
        ...
        params = [
            ...
            {'params': alg.classifier.parameters(), 'lr': args.lr_decay1 * init_lr},
            {'params': alg.bottleneck.parameters(), 'lr': args.lr_decay2 * init_lr},
            {'params': alg.regressor.parameters(), 'lr': args.lr_decay2 * init_lr},
        ...
        params = [
            {'params': alg.cgan_discriminator.parameters(), 'lr': args.lr_decay1 * init_lr*0.01}
        ]
        return params
